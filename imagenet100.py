...
class ImageNet100S(CustomImageNet):
    def __init__(self, data_path, **kwargs):
...
DATASETS['imagenet100s'] = ImageNet100S


def get_loaders(dataset, n_ex, batch_size, train_set, shuffle, data_augm, data_dir=None, n_train=-1, p_label_noise=0.0, drop_last=False):
